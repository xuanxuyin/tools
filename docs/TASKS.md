...
- [x] 👤 ~~拼豆提案 AITDK 拉量（16 词）~~ **✅ 9/25 完成 → 立项成立**：主族 ≈30.4K/月过 10K 定标 3 倍（patterns 14.8K + ideas 9.9K + fuse/easy/templates/christmas/animals/halloween/food），KD 全带 14~35 → **chartglade V2.0 拼豆图纸簇立项，10/25 批首批 5 页**（hub + easy/animals/food/christmas，全原创图案零 IP）；perler beads 40.5K 导航词 KD41 弃、pony bead 6.6K 第二批。明细 [research/fuse-bead-patterns.md](../research/fuse-bead-patterns.md) §七 + chartglade PLAN 9/25 行
